...
public interface OpsInterface {
     ...
     * @param stackMode 压栈类型
     */
    public void jumpFragmentForResult(RootFragment from, @NonNull RootFragment to, Bundle bundle, FragmentAnimBean animBean, int requestCode, @StackModeManager.StackMode int stackMode);
     ...
     * @param target
     */
    public void replace(@NonNull RootFragment target);
     ...
     *
     * @param from
     *      增加跳转的来源，跟上面的{@link OpsInterface#jumpActivityForResult(Class, Bundle, FragmentAnimBean, int)}类似
